...
export const UserDetailsForm = ({
  ...
  //   const [showForm, setShowForm] = useState(false); // using state and callback from UserDetails instead
  ...
  // is getting username from cookie in apiSlice more secure for submission?
